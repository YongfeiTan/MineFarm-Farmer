...
class MineFarmFarmer(gym.Env):
    ...
    def step(self, action):
        ...
        if self.agentinf.LineOfSight == 'Zombie':
        ...
        if self.agentinf.near is not None:
            ...
            if lifevalue > self.agentinf.life:
                ...
                reward += 2
            if info['name'] == "Zombie" and self.agentinf.LineOfSight == 'zombie' and command == 'attack 1':
                reward += 10
            elif info['name'] == "Zombie" and action_command == 'attack 1':
                reward += 2
    ...
    def get_observation(self, world_state, agent):
        obs = np.zeros((1, OBS_SIZE, OBS_SIZE))
